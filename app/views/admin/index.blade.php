                ...
                <div id="collapse-{{ ucfirst($va->slug) }}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading-{{ ucfirst($va->slug) }}">
                    <div class="panel-body">
                        ...
                        <div>
                            ...
                            <a class="btn btn-info pull-right" href="{{ $remoteSrvConfig['production']['http']['url'] }}/{{ $va->slug }}" role="button" target="_blank" style="margin-left:5px;"><span class="glyphicon glyphicon-search"></span> Ausspielungsserver Nr. {{ $remoteSrvNo }}</a>
                            @endforeach
                            @endif
                        </div>
                    </div>

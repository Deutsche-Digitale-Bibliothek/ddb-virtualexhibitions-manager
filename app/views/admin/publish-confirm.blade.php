...
@section('content')
        ...
        <ul class="list-unstyled">
            ...
            <li class="text-success"><span class="glyphicon glyphicon-time" style="color:#666;"></span> Zuletzt von den Ausspielungsservern gelöscht am: <?php echo date('d.m.Y \u\m H:i:s', strtotime($va->last_published_at)); ?> Uhr.</li>
            @endif
        </ul>

...
(64,	3,	11,	'Typ',	'Beschreibung Metadatenfeld Typ',	'Zusatzvermerk Metadatenfeld Typ'),
(65,	3,	23,	'Thema',	'Beschreibung Metadatenfeld Thema',	'Zusatzvermerk Metadatenfeld Thema'),
...
(79,	3,	12,	'Teil von',	'Beschreibung Metadatenfeld Teil von',	'Zusatzvermerk Metadatenfeld Teil von'),
...
(86,	3,	10,	'Copyright',	'Beschreibung Metadatenfeld Copyright',	'Zusatzvermerk Metadatenfeld Copyright');
...
CREATE TABLE `omeka_exhxxxx-exhibit-number-xxxx_exhibits` (
  ...
  `added` timestamp NOT NULL DEFAULT '2000-01-01 00:00:01',
  `modified` timestamp NOT NULL DEFAULT '2000-01-01 00:00:01',
  `owner_id` int(10) unsigned DEFAULT NULL,
  `institutions` text COLLATE utf8_unicode_ci,
  `team` text COLLATE utf8_unicode_ci,
  `imprint` text COLLATE utf8_unicode_ci,
  `legal` text COLLATE utf8_unicode_ci,
  `titlebackground` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `titlebackgroundcolor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  ...
  `startpagethumbnail` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `omeka_exhxxxx-exhibit-number-xxxx_exhibit_pages` (
  ...
  `textalign` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `backgroundcolor` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `pageoptions` longtext COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
...
CREATE TABLE `omeka_exhxxxx-exhibit-number-xxxx_exhibit_page_entries` (
  ...
  `order` tinyint(3) unsigned NOT NULL,
  `s_options` text COLLATE utf8_unicode_ci,
  PRIMARY KEY (`id`),
...
(159, 'file_extension_whitelist', 'gif,jpeg,jpg,mp3,ogg,png'),
(160, 'file_mime_type_whitelist', 'application/ogg,application/x-ogg,audio/mp3,audio/ogg,audio/x-mp3,image/gif,image/jpeg,image/pjpeg,image/png'),
...
(165, 'html_purifier_allowed_html_attributes',  '*.class,a.href,a.title,a.target'),
(176, 'bookreader_custom_library',  '../lib/omeka/plugins/BookReader/libraries/BookReaderCustom.php'),
...
(261, 'gina_admin_mod_dashboard_panel_content', '<p><a title=\"Kuratoren-Handbuch online\" href=\"https://deutsche-digitale-bibliothek.github.io/ddb-virtualexhibitions-docs-litfass/\" target=\"_blank\" rel=\"noopener\">Benutzungs-Handbuch online</a></p><h4>Ansprechpersonen:</h4><p>Lidia Westermann<br /><a href=\"mailto:ddbstudio@deutsche-digitale-bibliothek.de\">ddbstudio@deutsche-digitale-bibliothek.de</a></p><p><em>Bei Fragen schreiben Sie uns bitte eine E-Mail, wir antworten so schnell wie möglich.</em></p>'),
...
(7, 'SimpleVocab',  1,  '2.1'),
(9,	'ExhibitColorSchemeDesigner',	1,	'1.0.0');
...
CREATE TABLE `omeka_exhxxxx-exhibit-number-xxxx_users` (
  ...
  `role` varchar(255) COLLATE utf8_unicode_ci NOT NULL DEFAULT 'default',
  `confirm_use` tinyint(4) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `omeka_exhxxxx-exhibit-number-xxxx_users_activations` (
  ...
  `added` datetime DEFAULT '2000-01-01 00:00:00',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
DROP TABLE IF EXISTS `omeka_exhxxxx-exhibit-number-xxxx_exhibit_color_palettes`;
CREATE TABLE `omeka_exhxxxx-exhibit-number-xxxx_exhibit_color_palettes` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `palette` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `color` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `hex` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `menu` tinyint(4) unsigned NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

INSERT INTO `omeka_exhxxxx-exhibit-number-xxxx_exhibit_color_palettes` (`id`, `palette`, `color`, `hex`, `type`, `menu`) VALUES
(1,	'a',	'grey',	'#3d4f58',	'dark',	0),
(2,	'a',	'red',	'#e73235',	'dark',	0),
...
(10,	'b',	'orange',	'#e8542c',	'dark',	1),
(11,	'b',	'oliv',	'#867f4e',	'dark',	0),
(12,	'c',	'grey',	'#3d4f58',	'dark',	0),
(13,	'c',	'green',	'#ccdad6',	'light',	0),
(14,	'c',	'blue',	'#e3f3fe',	'light',	0),
(15,	'c',	'sand',	'#f6f9ea',	'light',	0),
(16,	'c',	'apricot',	'#f7cbba',	'light',	1),
(17,	'c',	'rose',	'#e8b4b4',	'light',	0),
(18,	'd',	'grey',	'#3d4f58',	'dark',	0),
(19,	'd',	'melon',	'#eb567e',	'dark',	1),
(20,	'd',	'sand',	'#d8ba92',	'light',	0),
(21,	'd',	'powder_sand',	'#f1f0e3',	'light',	0),
(22,	'd',	'khaki',	'#8ca665',	'light',	0),
(23,	'd',	'pastell_khaki',	'#bacaa2',	'light',	0),
(24,	'e',	'blue',	'#274e6c',	'dark',	0),
(25,	'e',	'creme',	'#fcf3d9',	'light',	0),
(26,	'e',	'moustard',	'#fdca2f',	'light',	0),
(27,	'e',	'curry',	'#f59c33',	'light',	0),
(28,	'e',	'rusty',	'#bb4920',	'dark',	1),
(29,	'f',	'green',	'#204127',	'dark',	0),
(30,	'f',	'moss',	'#3e8c35',	'dark',	0),
(31,	'f',	'blue',	'#274ebc',	'dark',	0),
(32,	'f',	'rusty',	'#bb4920',	'dark',	1),

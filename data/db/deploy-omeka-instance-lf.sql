...
(159, 'file_extension_whitelist', 'gif,jpeg,jpg,mp3,mpeg,mpg,ogg,png'),
(160, 'file_mime_type_whitelist', 'application/ogg,application/x-ogg,audio/mp3,audio/ogg,audio/x-mp3,audio/mpeg,audio/mpeg3,audio/x-mpeg,audio/x-mpeg3,audio/x-mpegaudio,image/gif,image/jpeg,image/pjpeg,image/png'),
...
(165, 'html_purifier_allowed_html_attributes',  '*.class,a.href,a.title,a.target,p.style,h1.style,h5.style,h4.style,h3.style,h2.style'),
...
(1,	'base',	'white',	'#ffffff',	'light',	0),
(2,	'base',	'lightgray',	'#eeeeee',	'light',	0);